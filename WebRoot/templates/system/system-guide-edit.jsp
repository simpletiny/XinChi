...
<body>
	...
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				修改系统指南<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
	...
	<script src="<%=basePath%>static/js/system/system-guide-edit.js"></script>
</body>
</html>