...
<body>
					...
					<div class="form-group">
						<div style="width: 30%; float: right">
							<s:if test="#session.user.user_roles.contains('ADMIN')||#session.user.user_roles.contains('MANAGER')">
								<div>
									<button type="submit" class="btn btn-green col-md-1" data-bind="click: function() { createGuide() }">新建</button>
								</div>
								<div>
					...
					<table class="table table-striped table-hover">
						...
						<tbody data-bind="foreach: views">
							<tr style="overflow: hidden">
								...
								<td><a href="javascript:void(0)" data-bind="text: $data.title,attr: {href: 'system-guide-preview.jsp?key='+$data.pk}"></a></td>
	...
	<script src="<%=basePath%>static/js/system/system-guide.js"></script>
</body>
</html>