				...
				<form class="form-box info-form">
					<div class="input-row clearfloat">
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" data-bind=" options:itemMapping,optionsText: 'value',optionsValue:'key'" name="reimbursement.item" required="required"></select>
							</div>
						</div>
						<div class="col-md-6 required">
								<label class="l">日期</label>
								<div class="ip">
								 <input type="text"  class="ip-default date-picker" placeholder="2013-10-19" name="reimbursement.date"
									required="required" />
									</div>
							</div>
