...
<jsp:include page="../layout.jsp" />
    <div class="subtitle">
        <h2>机票供应商员工新建<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a></h2>
    </div>
                ...
                <div class="input-row clearfloat">
                   ...
                   <div class="input-row clearfloat">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="ip"><input type="text" class="ip- date_year" maxlength="4" data-bind="value: employee().body_birth_year" placeholder="出生年" name="employee.birth_year" /></div>
                    </div>
  ...
  <script src="<%=basePath %>static/js/ticket/employee-creation.js"></script>
</body>
</html>