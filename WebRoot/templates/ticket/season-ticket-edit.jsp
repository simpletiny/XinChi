...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				套票编辑<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
		...
		<div class="main-container">
			<div class="main-box">
				<form class="form-box info-form">
					<input type="hidden" id="key" name="base.pk" value="<%=key%>" />
					<div class="input-row clearfloat">
						<div class="col-md-3 required">
							<label class="l" style="width: 25%">套票名称</label>
							<div class="ip" style="width: 50%">
								<input type="text" class="ip- date-picker" name="base.name" data-bind="value:seasonTicket().name" required="required" placeholder="好区分的名称" />
							</div>
						</div>
						<div class="col-md-3 required">
							<label class="l" style="width: 25%">编号</label>
							<div class="ip" style="width: 50%">
								<input type="text" class="ip- date-picker"  data-bind="value:seasonTicket().model" placeholder="用于区分同名称套票" maxlength="10" name="base.model"
									required="required" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-3 required">
							...
							<div class="ip" style="width: 50%">
								<input st="supplier-name" type="text" class="ip-" data-bind="value:seasonTicket().supplier_employee_name" onclick="choseSupplierEmployee(event)" required="required"
									placeholder="票源供应商" /> <input type="hidden" st="supplier-pk" data-bind="value:seasonTicket().supplier_employee_pk" name="base.supplier_employee_pk" />
							</div>
						</div>
						<div class="col-md-3 required">
							<label class="l" style="width: 25%">价格</label>
							<div class="ip" style="width: 50%">
								<input type="number" class="ip- date-picker" name="base.price" data-bind="value:seasonTicket().price" required="required" placeholder="套票单价" />
							</div>
						</div>
						<div class="col-md-3 required">
							<label class="l" style="width: 25%">儿童价格</label>
							<div class="ip" style="width: 50%">
								<input type="number" class="ip- date-picker" name="base.special_price" data-bind="value:seasonTicket().special_price" required="required" placeholder="儿童价格" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat" id="air-ticket">
						<div class="col-md-12">
							<table style="width: 100%" id="table-ticket">
								...
								<tbody data-bind="foreach:seasonTicket().infos">
									<tr>
										<!-- ko if:$data.index_leg=='A' -->
										<td>A<input type="hidden" st="index-leg" value="A" /></td>
										<!-- /ko -->
										<!-- ko if:$data.index_leg!='A' -->
										<td data-bind=""><input type="text" st="index-leg" data-bind="value:$data.index_leg" /></td>
										<!-- /ko -->
										<td><input st="start-day" type="number" data-bind="value:$data.start_day" maxlength="2" min="1" max="20" required="required" /></td>
										<td><input st="ticket-number" type="text" data-bind="value:$data.ticket_number" maxlength="10" required="required" /></td>
										<td><input st="ticket-leg" type="text" data-bind="value:$data.ticket_leg"  onclick="choseAirLeg(event)" maxlength="20" required="required" /></td>
										<td><input st="start-time" type="text" data-bind="value:$data.start_time" maxlength="5" onkeyup="formatTime(this)" onblur="checkTime(this)"
											required="required" /></td>
										<td><input st="end-time" type="text" data-bind="value:$data.end_time" maxlength="5" onkeyup="formatTime(this)" onblur="checkTime(this)"
											required="required" /></td>
										<td style="float: left"><input st="is-add-day" type="checkbox" data-bind="checked:$data.add_day_flg=='Y'"/>+1</td>
										<td><input st="start-place" type="text" data-bind="value:$data.start_place" maxlength="20" /></td>
										<td><input st="end-place" type="text" data-bind="value:$data.end_place" maxlength="20" /></td>
									</tr>
								</tbody>
							</table>
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<textarea type="text" class="ip-default" rows="5" maxlength="200" name="base.comment" data-bind="value:seasonTicket().comment" placeholder="需要备注说明的信息"></textarea>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-12" style="text-align: right">
							<a type="submit" class="btn btn-green btn-r" data-bind="click: updateFlight">更新</a>
						</div>
					</div>
				</form>
	...
	<script src="<%=basePath%>static/js/ticket/season-ticket-edit.js"></script>
</body>
</html>