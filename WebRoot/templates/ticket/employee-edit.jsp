...
<jsp:include page="../layout.jsp" />
    <div class="subtitle">
        <h2>机票供应商员工编辑<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a></h2>
    </div>
...
<div id="financial_pick" style="display:none;">
  ...
  <script src="<%=basePath %>static/js/ticket/employee-edit.js"></script>
</body>
</html>