...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				机票供应商编辑<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
		...
		<div class="main-container">
			<div class="main-box">
				...
				<div align="right">
					<a type="submit" class="btn btn-green btn-r" data-bind="click: saveSupplier">保存</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="<%=basePath%>static/js/ticket/supplier-edit.js"></script>
</body>
</html>