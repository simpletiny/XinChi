...
<body>
				...
				<form class="form-horizontal search-panel">
					<div class="form-group">
						<div style="width: 30%; float: right">
							<div>
								<button type="submit" class="btn btn-green col-md-1" data-bind="click: function() { createFlight() }">新建航班</button>
	...
	<script src="<%=basePath%>static/js/ticket/flight-management.js"></script>
</body>
</html>