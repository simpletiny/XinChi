...
<body>
					...
					<table class="table table-striped table-hover">
						...
						<tbody data-bind="foreach: views">
							<tr style="overflow: hidden">
								...
								<td><a href="javascript:void(0)" data-bind="text: $data.title,attr: {href: 'rule-view-preview.jsp?key='+$data.pk}"></a></td>
	...
	<script src="<%=basePath%>static/js/culture/rule-view.js?1.0"></script>
</body>
</html>