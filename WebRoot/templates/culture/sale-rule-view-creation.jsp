...
<body>
	<div class="main-body">
		<div class="subtitle">
			<h2>
				新建销售制度<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
	...
	<script src="<%=basePath%>static/js/culture/sale-rule-view-creation.js"></script>
</body>
</html>