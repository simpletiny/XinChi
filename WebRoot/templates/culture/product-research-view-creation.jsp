...
<body>
	<div class="main-body">
		<div class="subtitle">
			<h2>
				新建产品学院<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
				...
				<form class="form-box info-form" id="form_container">
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="text" maxlength="20" class="ip-" data-bind="value: view().title" placeholder="标题" name="view.title"
									required="required" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							<label class="l">标签</label>
							<div class="ip">
								<select class="form-control" style="height: 34px"
									data-bind="options: labels,  optionsText: 'label_name', optionsValue: 'label_name'" name="view.label"></select>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
	...
	<script src="<%=basePath%>static/js/culture/product-research-view-creation.js"></script>
</body>
</html>