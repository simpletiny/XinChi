...
<body>
					...
					<table class="table table-striped table-hover">
						...
						<tbody data-bind="foreach: views">
							<tr style="overflow: hidden">
								...
								<td><a href="javascript:void(0)" data-bind="text: $data.title,attr: {href: 'product-view-preview.jsp?key='+$data.pk}"></a></td>
	...
	<script src="<%=basePath%>static/js/culture/product-view.js"></script>
</body>
</html>