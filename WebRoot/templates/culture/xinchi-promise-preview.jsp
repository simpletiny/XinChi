...
<body>
	...
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				欣驰承诺<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
	...
	<script src="<%=basePath%>static/js/culture/xinchi-promise-preview.js"></script>
</body>
</html>