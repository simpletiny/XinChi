...
<body>
	<div class="main-body">
		<div class="subtitle">
			<h2>
				新建产品研发文档<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
	...
	<script src="<%=basePath%>static/js/culture/product-academy-view-creation.js"></script>
</body>
</html>