...
<body>
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" style="height: 34px"
									data-bind="options: labels,  optionsText: 'label_name', optionsValue: 'label_name',value:view().label" name="view.label"></select>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
	...
	<script src="<%=basePath%>static/js/culture/product-research-view-edit.js"></script>
</body>
</html>