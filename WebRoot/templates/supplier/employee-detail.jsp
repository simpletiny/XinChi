...
<jsp:include page="../layout.jsp" />
    <div class="subtitle">
        <h2>查看供应商员工信息<a  href="<%=basePath %>/templates/supplier/supplier-employee.jsp"  class="cancel-create">返回</a></h2>
    </div>
  ...
  <script src="<%=basePath%>static/js/supplier/employee-detail.js"></script>
</body>
</html>