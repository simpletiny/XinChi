             ...
             <input type="hidden" id="supplier_key" name = "supplier.pk" value="<%=key%>">
                ...
                <div class="input-row clearfloat">
                    <div class="col-md-6 required">
                        ...
                        <div class="ip"><input type="text" class="ip- cellphone" maxlength="11" data-bind="value: supplier().body_cellphone" placeholder="财务主体手机号" name="supplier.body_cellphone" required="required"/></div>
                    </div>
                    <div class="col-md-6">
