				...
				<form class="form-horizontal search-panel">
					...
					<div class="form-group">
						<div class="span6">
							...
							<div class="col-md-2">
								<input type="text" class="form-control" placeholder="姓名" name="employee.name" />
							</div>
						</div>
						<div class="span6">
					...
					<div class="form-group">
						<div class="span6">
							...
							<div class="col-md-2">
								<select style="height: 32px" class="form-control" data-bind="options: provices, optionsCaption: '-- 省份--',value: supplier().supplier_provice,event:{change:ter}"
									name="employee.employee_provice"></select>
							</div>
							<div class="col-md-2">
