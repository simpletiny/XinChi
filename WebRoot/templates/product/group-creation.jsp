...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				新建产品组<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
				...
				<form class="form-box info-form" id="form_container">
					<div class="input-row clearfloat">
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" style="height: 34px" data-bind="options: users,  optionsText: 'user_name', optionsValue: 'user_number',, optionsCaption: '--请选择--'" name="group.group_leader" required="required"></select>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
	...
	<script src="<%=basePath%>static/js/product/group-creation.js"></script>
</body>
</html>