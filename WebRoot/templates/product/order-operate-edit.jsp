...
<%
	...
	String order_number = request.getParameter("key");
%>
...
<body>
	<div class="main-body">
		...
		<input type="hidden" id="key" value="<%=order_number %>" />
	...
	<script src="<%=basePath%>static/js/product/order-operate-edit.js"></script>
</body>
</html>