...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				修改地接信息<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
		...
		<div class="main-box">
			...
			<hr />
			<div id="div-supplier" data-bind="foreach:{data:order_suppliers,as:'supplier'}">
				<div>
					<h3>地接信息</h3>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						<div class="col-md-3 required">
							...
							<div class="fix-width1">
								<input type="text" class="ip- required date-picker" data-bind="value:$data.pick_date" st="pick-date" />
							</div>
						</div>
						<div class="col-md-3 required">
							<label class="l">天数</label>
						...
						<div class="col-md-3 required">
							...
							<div class="ip" style="width: 50% !important">
								<input type="number" class="ip- required"
									data-bind="value:$data.supplier_cost"
									st="supplier-cost" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						...
						<div class="col-md-4">
							...
							<div class="ip">
								<textarea type="text" class="ip-default" st="payable-comment" rows="5"
									data-bind="value:$data.payable_comment" maxlength="200" placeholder="团款说明"></textarea>
							</div>
						</div>
					</div>
							...
							<div class="ip">
								<div style="padding-top: 4px;">
									<em class="small-box"> <input type="checkbox" data-bind="checked:$data.tourist_info.indexOf('name')>=0"
										...
										data-bind="checked:$data.tourist_info.indexOf('sex')>=0" name="chk_tourist" value="sex" /><label>性别</label> <input
										type="checkbox" data-bind="checked:$data.tourist_info.indexOf('age')>=0" name="chk_tourist" value="age" /><label>年龄</label>
										<input type="checkbox" name="chk_tourist" value="id" data-bind="checked:$data.tourist_info.indexOf('id')>=0" /><label>身份证号码</label>
										<input type="checkbox" name="chk_tourist" data-bind="checked:$data.tourist_info.indexOf('tel')>=0" value="tel" /><label>联系方式</label>
						...
						<table style="width: 100%;" class="table table-order" id="table-names">
							...
							<tbody data-bind="foreach:{data:supplier.sale_order_infos,as:'order'}">
								...
								<tr>
									...
									<input type="hidden" st="name-pk" data-bind="value:$data.name_pk" />
									...
									<td data-bind="attr: { rowspan:order.infos.length }"></td>
								</tr>
								<!-- /ko -->
								<!-- ko if: $index() != 0-->
								<tr>
			...
			<hr class="hr-big" />
			<div align="right">
				<a type="submit" class="btn btn-green btn-r" data-bind="click: updateOrderOperation">保存</a> <a type="submit"
		...
		<table style="width: 100%;" class="table table-order">
			...
			<tbody data-bind="foreach:{data:sale_orders,as:'order'}">
				...
				<tr>
					...
					<td><input class="required" type="number" oninput="editAll(this)" st="price" /></td>
