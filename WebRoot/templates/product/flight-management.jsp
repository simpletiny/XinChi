...
<body>
		...
		<div class="main-container">
			<div class="main-box">
				...
				<form class="form-box info-form">
					<input type="hidden" name="flight.product_pk" data-bind="value:product().pk" />
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6" style="text-align: right">
							<a type="submit" class="btn btn-green btn-r" data-bind="click: saveProductFlight">保存</a> <a type="submit"
								class="btn btn-green btn-r" data-bind="click: updateProductFlight">更新</a> <a type="submit"
	...
	<script src="<%=basePath%>static/js/product/flight-management.js"></script>
</body>
</html>