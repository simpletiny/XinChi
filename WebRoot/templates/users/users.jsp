...
<body>
	...
	<div id="edit-role" style="display: none">
		...
		<div class="input-row clearfloat">
			<div class="col-md-12">
				...
				<div class="ip">
					<div data-bind="foreach: userRoles" style="padding-top: 4px;">
						<em class="small-box"> <input type="checkbox"
							data-bind="attr: {'value': $data.code}, checked: $root.chosenUserRoles,event:{change:$root.changeRole}" /><label
		...
		<div class="input-row clearfloat" style="float: right">
			<a type="submit" class="btn btn-green btn-r" data-bind="click: doSave">保存</a> <a type="submit"
				class="btn btn-green btn-r" data-bind="click: doCancel">取消</a>
		</div>
	</div>

	<div id="div-product-mananger" style="display: none">
		<div class="input-row clearfloat">
			<div class="col-md-12">
				<label class="l">产品经理</label>
				<div class="ip">
					<div data-bind="foreach: productManagers" style="padding-top: 4px;">
						<em class="small-box"> <input type="checkbox"
							data-bind="attr: {'value': $data.user_number}, checked: $root.chosenProductManagers" /><label
		...
		<div class="input-row clearfloat" style="float: right">
			<a type="submit" class="btn btn-green btn-r" data-bind="click: confirmProductManager">确定</a> <a type="submit"
				class="btn btn-green btn-r" data-bind="click: cancelProductManager">取消</a>
		</div>
	</div>
	<div style="display: none; width: 600px" id="password-new">
		<div class="input-row clearfloat">
			<div class="col-md-12 required">
				...
				<div class="ip">
					<div class="ip">
						<input type="password" id="password_new" class="ip-default" placeholder="新密码" />
					</div>
				</div>
			</div>
		</div>
		<div class="input-row clearfloat">
			<button style="float: right; margin-top: 10px" type="submit" class="btn btn-green col-md-1"
				data-bind="click:doChangePassword">完成</button>
		</div>
	</div>
	...
	<script src="<%=basePath%>static/js/users/users.js?v=1.001"></script>
</body>
</html>