...
<jsp:include page="../layout.jsp" />
    <div class="subtitle">
        <h2>财务主体编辑<a  href="javascript:void(0)" onclick="javascript:history.go(-1);return false;"  class="cancel-create"><i class="ic-cancel"></i>取消</a></h2>
    </div>
             ...
             <input type="hidden" id="client_key" name = "client.pk" value="<%=key%>" />
                <div class="input-row clearfloat">
                    <div class="col-md-6 required">
                        ...
                        <div class="ip"><input type="text" id="name" class="ip-default" maxlength="30" data-bind="value: client().client_name" placeholder="公司名称" name="client.client_name" required="required"/></div>
                    </div>
                    <div class="col-md-6 required">
                        <label class="l">公司简称</label>
                        <div class="ip"><input type="text" id="name" maxlength="8"  maxlength="30" class="ip-default" data-bind="value: client().client_short_name" placeholder="公司简称" name="client.client_short_name" required="required"/></div>
                    </div>
                </div>
                <div class="input-row clearfloat">
                    <div class="col-md-6">
                ...
                <div class="input-row clearfloat">
                 ...
                 <div class="input-row clearfloat">
                    <div class="col-md-12 required">
                        ...
                        <div class="ip"><input type="text" class="ip-"  maxlength="100" data-bind="value: client().address" placeholder="地址" required="required" name="client.address"/></textarea></div>
                    </div>
                </div>
                <div class="input-row clearfloat">
                   <div class="col-md-12">
                        <label class="l">旅游公司</label>
                        <div class="ip"><input type="text" class="ip-" data-bind="value:client().agency_name,click:chooseAgency" placeholder="点击选择" name="client.agency_name" id="agency_name"/>
                        <input type="text" class="ip-" style="display:none" data-bind="value:client().agency_pk" name="client.agency_pk" id="agency_pk"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-row clearfloat">
                    <div class="col-md-6 required">
                        ...
                        <div class="ip"><input type="text" class="ip- date-picker"  maxlength="10" data-bind="value: client().body_name" placeholder="财务主体姓名" name="client.body_name" required="required"/></div>
                    </div>
                    <div class="col-md-6 required">
                ...
                <div class="input-row clearfloat">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="ip"><input type="text" class="ip-"  maxlength="20" data-bind="value: client().body_wechat" placeholder="财务主体微信" name="client.body_wechat"/></div>
                    </div>
                </div>
                <div class="input-row clearfloat">
                    <div class="col-md-6 required">
