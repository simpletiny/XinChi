...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				查看客户信息<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create">返回</a>
			</h2>
		</div>
				...
				<div class="form-box info-form">
					...
					<div class="input-row clearfloat">
						...
						<div class="col-md-6">
							...
							<div class="ip">
								<p class="ip-default" data-bind="text: employee().sex"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<p class="ip-default" data-bind="text: employee().area"></p>
							</div>
						</div>
						<div class="col-md-6">
							<label class="l">财务主体</label>
							<div class="ip">
								<p class="ip-" data-bind="text: employee().financial_body_name"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<p class="ip-" data-bind="text: employee().id"></p>
							</div>
						</div>
						<div class="col-md-6">
							<label class="l">出生年</label>
							<div class="ip">
								<p class="ip-" data-bind="text: employee().birth_year"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<p class="ip-" data-bind="text: employee().cellphone"></p>
							</div>
						</div>
						<div class="col-md-6">
							<label class="l">手机号2</label>
							<div class="ip">
								<p class="ip-" data-bind="text: employee().cellphone1"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<p class="ip-" data-bind="text: employee().wechat"></p>
							</div>
						</div>
						<div class="col-md-6">
							<label class="l">微信2</label>
							<div class="ip">
								<p class="ip-" data-bind="text: employee().wechat1"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						...
						<div class="col-md-12">
							...
							<div class="ip">
								<p class="ip- date-picker" data-bind="text: employee().qq"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-12">
							...
							<div class="ip">
								<p class="ip- date-picker" data-bind="text: employee().sales_name"></p>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-12">
							...
							<div class="ip">
								<p class="ip-default" data-bind="text: employee().comment"></p>
							</div>
						</div>
					</div>
				</div>
