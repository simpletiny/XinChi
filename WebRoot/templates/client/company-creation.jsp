...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				客户财务主体新建<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
		...
		<div class="main-container">
			<div class="main-box">
				<form class="form-box info-form">
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="text" id="name" maxlength="30" class="ip-default" data-bind="value: client().client_name"
									placeholder="主体名称" name="client.client_name" required="required" />
							</div>
						</div>
						<div class="col-md-6 required">
							<label class="l">主体简称</label>
							<div class="ip">
								<input type="text" maxlength="8" maxlength="30" id="name" class="ip-default"
									data-bind="value: client().client_short_name" placeholder="主体简称" name="client.client_short_name"
									required="required" />
							</div>
						</div>
					</div>
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" class="ip- date-picker" maxlength="10" data-bind="value: client().body_name" placeholder="姓名"
									name="client.body_name" />
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="input-row clearfloat">
						...
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" class="ip-" maxlength="20" data-bind="value: client().body_wechat" placeholder="微信"
					...
					<div class="input-row clearfloat">
						...
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" maxlength="4" class="ip- date_year" data-bind="value: client().body_birth_year"
				...
				<div align="right">
					<a type="submit" class="btn btn-green btn-r" data-bind="click: createCompany">保存</a>
				</div>
			</div>
		</div>
	</div>
