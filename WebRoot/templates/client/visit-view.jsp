...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				会见记录<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create">返回</a>
			</h2>
		</div>
						...
						<tbody data-bind="foreach: visits">
							<tr>
								...
								<td>
									...
									data-bind="click: function() { $root.checkVisitImg($data.visit_img,$data.date) }">查看</a> <!-- /ko -->
								</td>
							</tr>
						</tbody>
					</table>
	...
	<script src="<%=basePath%>static/js/client/visit-view.js?v=1.001"></script>
</body>
</html>