...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				被动咨询<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
				...
				<form class="form-box info-form">
						...
						<div class="col-md-12">
							<div class="ip required" style="width: 30%">
								<label class="l">日期</label> <input type="text" style="width: 50%" class="ip-default date-picker"
									data-bind="value: incoming().date" placeholder="2013-10-19" name="incoming.date" required="required" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-12 required">
							...
							<div class="ip">
								<select style="width: 30%" class="form-control" data-bind="options: type" name="incoming.type"
					...
					<div class="input-row clearfloat">
						<div class="col-md-12 required">
							...
							<div class="ip">
								<textarea id="txt-summary" type="text" class="ip-default" rows="15" maxlength="500"
									data-bind="value: incoming().summary" name="incoming.summary" placeholder="咨询效果(不少于20字)" required="required"></textarea>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
	...
	<script src="<%=basePath%>static/js/client/incoming-call.js?v=1.001"></script>
</body>
</html>