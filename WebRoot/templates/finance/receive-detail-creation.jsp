...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				财务收入<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
				...
				<form class="form-box info-form">
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" data-bind="options: accounts, optionsCaption: '-- 请选择 --', value: detail().account"
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="text" id="name" class="ip- datesecond-picker" data-bind="value: detail().time" placeholder="发生时间"
									name="detail.time" required="required" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						<div class="col-md-12">
							...
							<div class="ip">
								<textarea type="text" class="ip-default" rows="15" data-bind="value: detail().comment" name="detail.comment"
