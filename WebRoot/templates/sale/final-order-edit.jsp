...
<jsp:include page="../layout.jsp" />
    <div class="subtitle">
        <h2>决算订单修改(<b data-bind="text:order().team_number"></b>)<a href="<%=basePath %>/templates/sale/order.jsp" class="cancel-create"><i class="ic-cancel"></i>取消</a></h2>
    </div>
  ...
  <script src="<%=basePath %>static/js/sale/final-order-edit.js"></script>
</body>
</html>