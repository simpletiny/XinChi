				...
				<input type="hidden" value='Y' name="fnsOrder.confirm_flg"></input>
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="number" data-bind="value:order().fy" name="fnsOrder.fy" class="ip-" placeholder="FLY" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							<a href="javascript:;" class="a-upload">上传确认件<input type="file"  name="file" accept=".jpg,.png"/></a> <input type="hidden" id="txt-confirm-file"  data-bind="value:order().confirm_file" name="fnsOrder.confirm_file" />
						</div>
