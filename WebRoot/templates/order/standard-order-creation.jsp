...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				新建标准订单<span data-bind="text:independent_msg"></span><a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
		<input type="hidden" id="key" value="<%=key%>"></input> <input type="hidden" id="independent_flg" value="<%=independent_flg%>"></input>
				...
				<form class="form-box info-form" id="form_container">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" id="people-count" data-bind="value:order().other_count" placeholder="费用" name="bsOrder.adult_cost" />
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							<a href="javascript:;" class="a-upload">上传确认件<input type="file"  name="file" /></a> <input type="hidden" name="bsOrder.confirm_file" />
						</div>
