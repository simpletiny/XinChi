...
<body>
				...
				<form class="form-box info-form" id="form_container">
						...
						<div class="col-md-3 required">
							...
							<div class="ip fix-width">
								<input type="text" id="txt-client-employee-name" class="ip-"
									data-bind="value: employee().name,event:{click:choseClientEmployee}" placeholder="客户" name="sale_order.client_employee_name" required/>
							</div>
						...
						<div class="col-md-6 required"> 
							...
							<div class="ip">
								<input type="text" class="ip-" placeholder="产品名称" maxlength="20" id="txt-product-name" data-bind="value: order().product_name"
									name="sale_order.product_name" required="required" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat required">
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="number" class="ip-" data-bind="value: order().days" id="txt-days" placeholder="天数" name="sale_order.days"
									required="required" />
							</div>
						</div>
					</div>
						...
						<div class="col-md-6 required">
							...
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" id="people-count" data-bind="value:order().adult_count" placeholder="人数"
									name="sale_order.adult_count" required="required" />
							</div>
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" data-bind="value:order().adult_cost" placeholder="费用"
									name="sale_order.adult_cost" required="required" />
							</div>
						</div>
						<div class="col-md-6">
	...
	<script src="<%=basePath%>static/js/order/non-standard-order-confirm.js?v=1.006"></script>
