...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				编辑已确认单机票订单<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
		...
		<div class="main-container">
			<div class="main-box">
				<form class="form-box info-form" id="form_container">
					<input type="hidden" id="key" value="<%=key%>" name="sale_order.pk" />
					...
					<div class="input-row clearfloat">
						<div class="col-md-3 required">
							...
							<input type="text" class="ip-" id="txt-client-employee-pk" data-bind="value: employee().pk"
								style="display: none" name="sale_order.client_employee_pk" id="client-employee-pk" required/>
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="text" id="departure" class="ip- date-picker" required="required"
									data-bind="value: order().departure_date" placeholder="出团日期" name="sale_order.departure_date" />
							</div>
						</div>
						<div class="col-md-6 required">
						...
						<div class="col-md-6 required">
							...
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" id="people-count" required="required" data-bind="value:order().adult_count"
									placeholder="人数" name="sale_order.adult_count" />
							</div>
							<div class="ip" style="width: 30%">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="number" data-bind="value:order().fy" name="sale_order.fy" class="ip-" max="1000000" placeholder="FLY" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="number" data-bind="value:order().other_cost" name="sale_order.other_cost" max="1000000" class="ip-"
									placeholder="其他费用" />
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="input-row clearfloat required">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" data-bind="value:order().confirm_date" name="sale_order.confirm_date" required="required"
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" style="height: 34px"
									data-bind="value:order().product_manager_number,options: users,  optionsText: 'user_name', optionsValue: 'user_number',, optionsCaption: '--请选择--'"
									name="sale_order.product_manager" required="required"></select>
							</div>
						</div>
					</div>
					<hr />
				...
				<div align="right">
					<a type="submit" class="btn btn-green btn-r" data-bind="click: updateOrder">更新订单</a>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="<%=basePath%>static/js/order/only-ticket-order-confirm-edit.js?v=1.005"></script>
