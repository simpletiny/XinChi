		...
		<table style="width: 100%" id="name-table" class="table table-striped table-hover">
			...
			<tbody data-bind="foreach: passengers">
				<tr>
					...
					<td><input type="text" class="ip-" data-bind="value:$data.name" style="width: 90%" st="name"
						oninput="inputName(this)" /></td>
					<td><select class="form-control" data-bind="value:$data.sex" style="height: 34px" st="sex">
							<option value="">选择</option>
							<option value="M">男</option>
							<option value="F">女</option>
					</select></td>
					<td><input type="text" class="ip-" type="number" data-bind="value:$data.age" oninput="inputAge()"
						style="width: 90%" st="age" /></td>
					...
					<td st='td-as-adult'><input type="checkbox" style="display: none" onchange="checkAdult()"
						data-bind="checked:$data.as_adult" value='Y' st='as-adult' /></td>
					<!-- /ko -->
