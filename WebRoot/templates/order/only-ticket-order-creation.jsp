...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				单机票<a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;" class="cancel-create"><i
				...
				<form class="form-box info-form" id="form_container">
					<div class="input-row clearfloat">
						<div class="col-md-3">
							...
							<div class="ip fix-width">
								<input type="text" id="txt-client-employee-name" class="ip-" data-bind="event:{click:choseClientEmployee}"
									placeholder="客户" />
							</div>
							<input type="text" class="ip-" id="txt-client-employee-pk" style="display: none"
								name="bnsOrder.client_employee_pk" id="client-employee-pk" />
						</div>
						<div class="col-md-3">
							...
							<table style="width: 100%" id="table-ticket">
								...
								<tbody>
									<tr>
										...
										<td st="index">1</td>
										<td><input st="date" class="ip- date-picker" type="text" /></td>
										<td><input st="from-city" class="ip- " type="text" /></td>
										<td><input st="to-city" class="ip- " type="text" /></td>
					...
					<div class="input-row clearfloat" style="width: 900px">
						<div class="col-md-12">
							...
							<div class="ip">
								<textarea type="text" id="air-comment" class="ip-default air_comment" rows="5" maxlength="200"
									placeholder="票务需求"></textarea>
							</div>
						</div>
					</div>
					<hr />
	...
	<script src="<%=basePath%>static/js/order/only-ticket-order-creation.js?v=1.004"></script>
	<script src="<%=basePath%>static/js/order/non-standard-order-common.js?v=1.003"></script>
	<script src="<%=basePath%>static/js/order/only-ticket-order-common.js?v=1.003"></script>
</body>
</html>