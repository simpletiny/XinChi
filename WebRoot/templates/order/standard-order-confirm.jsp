				...
				<form class="form-box info-form" id="form_container">
						...
						<div class="col-md-3 required">
							...
							<div class="ip fix-width">
								<input type="text" id="txt-client-employee-name" class="ip-"
									...
									name="sale_order.client_employee_name" required />
							</div>
							<input type="text" class="ip-" id="txt-client-employee-pk" data-bind="value: employee().pk" style="display: none"
								name="sale_order.client_employee_pk" id="client-employee-pk" required />
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-4 required">
							...
							<div class="ip fix-width">
								<input type="text" id="txt-product-name" class="ip-"
									data-bind="value: product().name,event:{click:choseProduct}" placeholder="产品" name="sale_order.product_name"
									required /> <input type="hidden" data-bind="value: product().pk" id="txt-product-pk" name="sale_order.product_pk"
					...
					<div class="input-row clearfloat required">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" required="required" data-bind="value:confirm_date" name="sale_order.confirm_date"
