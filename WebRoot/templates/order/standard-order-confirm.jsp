...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				标准订单确认<span data-bind="text:independent_msg"></span><a href="javascript:void(0)" onclick="javascript:history.go(-1);return false;"  class="cancel-create"><i class="ic-cancel"></i>取消</a>
			</h2>
		</div>
		...
		<div class="main-container">
			<div class="main-box">
				<form class="form-box info-form" id="form_container">
					...
					<input type="hidden" value='Y' name="bsOrder.confirm_flg"></input>
					...
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							...
							<div class="ip">
								<input type="text" id="departure" class="ip- date-picker" data-bind="value: order().departure_date" placeholder="出团日期" required="required" name="bsOrder.departure_date"/>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="input-row clearfloat required">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="number" class="ip-" required="required" data-bind="value: order().receivable" placeholder="总团款" name="bsOrder.receivable" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
						<div class="col-md-6 required">
							...
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" id="people-count" data-bind="value:order().adult_count" placeholder="人数" name="bsOrder.adult_count" required="required"/>
							</div>
							<div class="ip" style="width: 30%">
								<input type="number" class="ip-" id="people-count" data-bind="value:order().adult_cost" placeholder="费用" name="bsOrder.adult_cost" required="required"/>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="input-row clearfloat required">
						<div class="col-md-12">
							...
							<div class="ip">
								<textarea style="width:500px" type="text" onblur="formatNameList(this)" id="txt-name-list" class="ip-default" rows="15" data-bind="value: order().name_list" name="bsOrder.name_list" placeholder="姓名+身份证号。"></textarea>
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat required">
						<div class="col-md-6">
							...
							<div class="ip">
								<input type="text" required="required" data-bind="value:confirm_date" name="bsOrder.confirm_date" class="ip- date-picker" placeholder="确认日期" />
							</div>
						</div>
					</div>
					<div class="input-row clearfloat">
					...
					<div class="input-row clearfloat">
						<div class="col-md-6">
							<a href="javascript:;" class="a-upload">上传确认件<input type="file"  name="file" /></a> <input type="hidden" id="txt-confirm-file"  data-bind="value:order().confirm_file" name="bsOrder.confirm_file" />
						</div>
