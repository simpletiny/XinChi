...
<body>
						...
						<div class="col-md-3 required">
							...
							<div class="ip fix-width">
								<input type="text" id="txt-client-employee-name" disabled="disabled" class="ip-"
									data-bind="value: employee().name" placeholder="客户" required/>
							</div>
						...
						<div class="col-md-6 required">
							...
							<div class="ip">
								<select class="form-control" style="height: 34px"
									data-bind="options: users,  optionsText: 'user_name', optionsValue: 'user_number',value:$root.order().product_manager_number, optionsCaption: '--请选择--'"
	...
	<script src="<%=basePath%>static/js/order/non-standard-order-confirm-edit.js?v=1.004"></script>
