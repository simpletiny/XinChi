...
<body>
	<div class="main-body">
		...
		<div class="subtitle">
			<h2>
				编辑已确认标准订单<span data-bind="text:independent_msg"></span><a href="javascript:void(0)"
								...
								<table style="width: 100%" id="name-table" class="table table-striped table-hover">
									...
									<tbody data-bind="foreach: passengers">
										<tr>
											...
											<td><input type="text" class="ip-" data-bind="value:$data.cellphone_A" style="width: 90%"
												st="cellphone_A" /></td>
											<td><input type="text" class="ip-" data-bind="value:$data.cellphone_B" style="width: 90%"
												st="cellphone_B" /></td>
											<td><input type="text" class="ip-" data-bind="value:$data.id" maxlength="18"
												oninput="autoPrice();autoCaculate()" style="width: 90%" st="id" /></td>
	...
	<script src="<%=basePath%>static/js/order/standard-order-confirm-edit.js"></script>
	<script src="<%=basePath%>static/js/order/standard-order-common.js"></script>
</body>
</html>