...
function addRow() {
	...
	var tr = $('<tr><input type="hidden" st="flight-index" value="1" /><td st="index"></td><td><input st="start-day" type="number" min="1" maxlength="2" /></td><td><input st="flight-number" type="text"/></td><td><input st="from-to-city" type="text" onclick="choseAirLeg(event)"/></td><td><input type="button" value="-" onclick="deleteRow(this)"></input></td></tr>');
