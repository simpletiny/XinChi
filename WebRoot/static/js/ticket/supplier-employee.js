var SupplierContext = function() {
	...
	self.createSupplierEmployee = function() {
		window.location.href = self.apiurl + "templates/ticket/employee-creation.jsp";
	};
	...
	self.refresh = function() {
		var param = $("form").serialize() + "&employee.type=A&employee.delete_flgs=N&employee.delete_flgs=Y";
