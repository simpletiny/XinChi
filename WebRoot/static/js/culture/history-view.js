var ViewContext = function() {
	...
	self.createView = function() {
		window.location.href = self.apiurl
				+ "templates/culture/history-view-creation.jsp";
	};
	...
	self.refresh = function() {
		var param = "&page.start=" + self.startIndex() + "&page.count="
				+ self.perPage;
		$.getJSON(self.apiurl + 'culture/searchHistoryViewByPage', param,
				function(data) {
								...
								$
										...
										.success(
												function(str) {
													if (str == "OK") {
														window.location.href = self.apiurl
																+ "templates/culture/history-view.jsp";
													}
												});
							}
						}
