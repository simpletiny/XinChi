...
var DetailContext = function() {
	...
	self.refresh = function() {
		...
		$.getJSON(self.apiurl + 'accounting/searchPaidDetailByPayNumber', param, function(data) {
	...
	self.checkVoucherPic = function(fileName,accountId) {
		...
		$("#img-pic").attr("src", self.apiurl + 'file/getFileStream?fileFileName=' + fileName + "&fileType=VOUCHER&subFolder="+accountId);
	};
	// 新标签页显示大图片
