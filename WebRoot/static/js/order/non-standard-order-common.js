...
const nameModule = (function(){
	var html  = `
	    ...
	    <td st="name-index"></td>
	    <td><input type="text" style="width: 90%" class="ip-" st="name" oninput="inputName(this)"/></td>
	    <td>
	    ...
	    <td><input type="text" class="ip-" maxlength="18" oninput="inputId(this);" style="width: 90%" st="id" /></td>
	    <td><img src="" alt="" /></td>
