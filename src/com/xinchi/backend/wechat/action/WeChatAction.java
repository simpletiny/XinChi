package com.xinchi.backend.wechat.action;
...
import com.xinchi.backend.wechat.utils.WXBizMsgCrypt;
...
public class WeChatAction extends BaseAction {
	private static final long serialVersionUID = 8945690079916717600L;
	...
	public String message() throws Exception {
		...
		// http://www.newxin.top/wechat/message?msg_signature=fe0d04cdc96e4faff04c09d7c069e5fe08c02b51
		// &timestamp=1780906163&
		// nonce=upa57z7y1tb&
		// echostr=u%2FdfGLWgF%2BKkbCrMSYQ5kPy80gjHyNuO9mhw3ESlRKsBcpcJsIFdBe55yOHibu4O1IYfcEjMeMhnmtIcVEkXbA%3D%3D
		HttpServletRequest request = ServletActionContext.getRequest();
		String met = request.getMethod();
		WXBizMsgCrypt wxcpt = new WXBizMsgCrypt(ResourcesConstants.STOKEN, ResourcesConstants.SENCODINGAESKEY, ResourcesConstants.SCORPID);
		if (met.equalsIgnoreCase("GET")) {
			resultStr = wxcpt.VerifyURL(msg_signature, timestamp, nonce, echostr);
			...
			String msg = wxcpt.DecryptMsg(msg_signature, timestamp, nonce, sb.toString());

			Map<String, String> infos = XMLUtils.toMap(msg);
			...
			resultStr = wxcpt.EncryptMsg("你好吗？", timestamp, nonce);
	...
	public static void main(String[] args) throws Exception {
		...
		// WXBizMsgCrypt wxcpt = new WXBizMsgCrypt(ResourcesConstants.STOKEN,
		// ResourcesConstants.SENCODINGAESKEY, ResourcesConstants.SCORPID);
		// /*
		// * ------------使用示例一：验证回调URL--------------- 企业开启回调模式时，企业微信会向验证url发送一个get请求
		...
		// * 以及企业微信推送过来的随机加密字符串(echostr), 这一步注意作URL解码。 2.验证消息体签名的正确性 3.
		// * 解密出echostr原文，将原文当作Get请求的response，返回给企业微信 第2，3步可以用企业微信提供的库函数VerifyURL来实现。
		// *
		// */
		// // 解析出url上的参数值如下：
