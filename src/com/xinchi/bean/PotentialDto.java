...
public class PotentialDto implements Serializable {
	...
	private int main_all;
	private int friend_all;
	private int market_all;
	private int try_all;
	...
	private int main_unknow;
	private int friend_unknow;
	private int market_unknow;
	private int try_unknow;
	private int ignore_unknow;
	private int new_unknow;

	public int getAll_all() {
		return all_all;
	}

	public int getCore_all() {
		return core_all;
	}

	public int getMain_all() {
		return main_all;
	}

	public int getFriend_all() {
		return friend_all;
	}

	public int getMarket_all() {
		return market_all;
	}

	public int getTry_all() {
		return try_all;
	}

	public int getIgnore_all() {
		return ignore_all;
	}

	public int getNew_all() {
		return new_all;
	}
	...
	public void setCore_all(int core_all) {
		this.core_all = core_all;
	}

	public void setMain_all(int main_all) {
		this.main_all = main_all;
	}

	public void setFriend_all(int friend_all) {
		this.friend_all = friend_all;
	}

	public void setMarket_all(int market_all) {
		this.market_all = market_all;
	}

	public void setTry_all(int try_all) {
		this.try_all = try_all;
	}

	public void setIgnore_all(int ignore_all) {
		this.ignore_all = ignore_all;
	}

	public void setNew_all(int new_all) {
	...
	public int getCore_unknow() {
		return core_unknow;
	}

	public int getMain_unknow() {
		return main_unknow;
	}

	public int getFriend_unknow() {
		return friend_unknow;
	}

	public int getMarket_unknow() {
		return market_unknow;
	}

	public int getTry_unknow() {
		return try_unknow;
	}

	public int getIgnore_unknow() {
		return ignore_unknow;
	}

	public int getNew_unknow() {
		return new_unknow;
	}
	...
	public void setAll_unknow(int all_unknow) {
		this.all_unknow = all_unknow;
	}

	public void setCore_unknow(int core_unknow) {
		this.core_unknow = core_unknow;
	}

	public void setMain_unknow(int main_unknow) {
		this.main_unknow = main_unknow;
	}

	public void setFriend_unknow(int friend_unknow) {
		this.friend_unknow = friend_unknow;
	}

	public void setMarket_unknow(int market_unknow) {
		this.market_unknow = market_unknow;
	}

	public void setTry_unknow(int try_unknow) {
		this.try_unknow = try_unknow;
	}

	public void setIgnore_unknow(int ignore_unknow) {
		this.ignore_unknow = ignore_unknow;
	}
