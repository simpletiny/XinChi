...
public class OrderSupplierInfoBean extends SupperBO implements Serializable {
	private static final long serialVersionUID = -4003981020466299402L;

	private String pk;

	private String order_supplier_pk;
	...
	public String getOrder_supplier_pk() {
		return order_supplier_pk;
	}
	...
	public void setOrder_supplier_pk(String order_supplier_pk) {
		this.order_supplier_pk = order_supplier_pk;
	}
